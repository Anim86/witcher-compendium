...
for f in sorted(glob.glob('e:/AntigravitiProgetti/CompendioTheWitcher/witcher-compendium/src-packs/witcher-races/*.json')):
...
for f in sorted(glob.glob('e:/AntigravitiProgetti/CompendioTheWitcher/witcher-compendium/src-packs/witcher-professions/*.json')):
    d = json.load(open(f, encoding='utf-8'))
