...
| **Compartimento Segreto** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/compartimento_segreto.webp` | ✅ Presente | `33efbccc` |  -  | ✅ **Ottimizzata ed Integrata** (Generata manualmente dall'utente, ottimizzata WebP) |
...
| **Profumo / Acqua di Colonia** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/profumo_acqua_di_colonia.webp` | ✅ Presente | `58f63b54` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Prostituta** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/prostituta.webp` | ✅ Presente | `b869124c` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
...
| **Sacca da Viaggio** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/sacca_da_viaggio.webp` | ✅ Presente | `6fd2b96d` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Sacco** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/sacco.webp` | ✅ Presente | `6fd2b96d` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Sapone** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/sapone.webp` | ✅ Presente | `58f63b54` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Scrigno di Legno** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/scrigno_di_legno.webp` | ✅ Presente | `6fd2b96d` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
...
| **Specchietto** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/specchietto.webp` | ✅ Presente | `58f63b54` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Stallaggio** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/stallaggio.webp` | ✅ Presente | `b2273578` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Stanza in Locanda d'Alta Classe** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/stanza_in_locanda_d_alta_classe.webp` | ✅ Presente | `b2273578` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
...
| **Stanza in Locanda Economica** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/stanza_in_locanda_economica.webp` | ✅ Presente | `b2273578` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Stanza in Locanda Malfamata** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/stanza_in_locanda_malfamata.webp` | ✅ Presente | `b2273578` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Stanza in Locanda Media** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/stanza_in_locanda_media.webp` | ✅ Presente | `b2273578` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Strumenti Chirurgici** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/strumenti_chirurgici.webp` | ✅ Presente | `58f63b54` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Strumenti per le Belle Arti** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/strumenti_per_le_belle_arti.webp` | ✅ Presente | `58f63b54` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Strumento Musicale** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/strumento_musicale.webp` | ✅ Presente | `a15119de` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Strumento Musicale Elfico** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/strumento_musicale_elfico.webp` | ✅ Presente | `a15119de` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Superalcolici** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/superalcolici.webp` | ✅ Presente | `24203def` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Tabacco** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/tabacco.webp` | ✅ Presente | `c8bc1b9a` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
...
| **Telecomunicatore** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/telecomunicatore.webp` | ✅ Presente | `eca12634` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Tenda** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/tenda.webp` | ✅ Presente | `ca6c73b4` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Tenda Grande** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/tenda_grande.webp` | ✅ Presente | `364ac5c0` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Traversata per Mare** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/traversata_per_mare.webp` | ✅ Presente | `1628d929` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Utensili da Armaiolo** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/utensili_da_armaiolo.webp` | ✅ Presente | `9c4ad6f6` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Utensili da Cucina** | `modules/witcher-compendium/assets/EQUIPAGGIAMENTO/witcher-equipment/utensili_da_cucina.webp` | ✅ Presente | `a4898b80` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
...
## 📜 3. TABELLA SCHEMI DA GENERARE (19 Asset - witcher-schematics)
Questi schemi fanno parte della categoria **Schemi di Artigianato (witcher-schematics)**. I relativi asset devono essere salvati nella cartella dedicata degli schemi su disco.

| Nome Schema | Path Immagine Target | Stato Icona | Note / Prompt Consigliato per la Generazione |
| :--- | :--- | :---: | :--- |
| **Schema: Stiletto** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_stiletto.webp` | ✅ Presente | `1a8f1356` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Tirapugni** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_tirapugni.webp` | ✅ Presente | `b80344f3` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Vero Bastone del Vincolo** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_vero_bastone_del_vincolo.webp` | ✅ Presente | `1d70c45f` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Munizioni Bodkin** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_munizioni_bodkin.webp` | ✅ Presente | `3c2e4d3f` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Lino** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_lino.webp` | ✅ Presente | `c1e366d8` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Legname Indurito** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_legname_indurito.webp` | ✅ Presente | `f87a13b8` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Lino a Doppia Trama** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_lino_a_doppia_trama.webp` | ✅ Presente | `40471e45` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Filo** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_filo.webp` | ✅ Presente | `ffd0a497` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Dimeritium** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_dimeritium.webp` | ✅ Presente | `2cc9c17f` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Dimeritium Mahakaman** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_dimeritium_mahakaman.webp` | ✅ Presente | `f91910c8` |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Cuoio** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_cuoio.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Cuoio Borchiato** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_cuoio_borchiato.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Cuoio di Dragonide** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_cuoio_di_dragonide.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Cuoio Indurito** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_cuoio_indurito.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Cuoio Lyriano** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_cuoio_lyriano.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Acciaio** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_acciaio.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Acciaio Mahakaman** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_acciaio_mahakaman.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Acciaio Nero** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_acciaio_nero.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |
| **Schema: Acciaio Tretogor** | `modules/witcher-compendium/assets/ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_acciaio_tretogor.webp` | ✅ Presente | - |  -  | ✅ **Generata ed Integrata** (Generata con AI, ottimizzata WebP) |

## 🔄 4. DETTAGLI DELLE DELEZIONI STORICHE (Git Audit)
