...
// Take Batch 27 (first 15)
const BATCH_SIZE = 15;
const batchItems = selectedItems.slice(0, BATCH_SIZE);

const translations = {
    "Schema Armatura della Lumaca": "a glowing alchemical schematic for snail-themed armor",
    "Schema Spada d'Acciaio della Lumaca": "a glowing alchemical schematic for a snail-themed steel sword",
    "Schema Spada d'Argento della Lumaca": "a glowing alchemical schematic for a snail-themed silver sword",
    "Schema Armatura del Gatto": "a glowing alchemical schematic for Feline School armor",
    "Schema Armatura del Grifone": "a glowing alchemical schematic for Griffin School armor",
    "Schema Armatura del Lupo": "a glowing alchemical schematic for Wolf School armor",
    "Schema Armatura del Manticora": "a glowing alchemical schematic for Manticore School armor",
    "Schema Armatura del Orso": "a glowing alchemical schematic for Ursine School armor",
    "Schema Armatura del Vipera": "a glowing alchemical schematic for Viper School armor",
    "Schema Balestra del Gatto": "a glowing alchemical schematic for a Feline School crossbow",
    "Schema Balestra del Grifone": "a glowing alchemical schematic for a Griffin School crossbow",
    "Schema Balestra del Orso": "a glowing alchemical schematic for an Ursine School crossbow",
    "Schema Scudo del Manticora": "a glowing alchemical schematic for a Manticore School shield",
    "Schema Spada d'Acciaio del Gatto": "a glowing alchemical schematic for a Feline School steel sword",
    "Schema Spada d'Acciaio del Grifone": "a glowing alchemical schematic for a Griffin School steel sword"
};
...
<body>
    <h1>Prompts Batch ${BATCH_NUMBER} (Schemi di Fabbricazione)</h1>
