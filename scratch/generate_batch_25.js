...
const translations = {
    ...
    "Corna di Silvano": "the small twisted horns of a sylvan monster",
    "Essenza della Morte": "a glowing translucent white essence of death",
    "Polvere di Smeraldo": "a pile of fine shimmering green emerald dust",
    "Denti di Gatto Mannaro": "a set of sharp pointed teeth from a werecat",
    "Mutageno Alp (Blu)": "a glowing blue organic mutagenic orb from an alp",
    "Mutageno Gatto Mannaro (Rosso)": "a glowing red organic mutagenic orb from a werecat",
    "Mutageno Glustyworp (Verde)": "a glowing green organic mutagenic orb from a glustyworp",
    "Saliva di Alp": "a jar of thick translucent alp saliva",
    "Stomaco di Glustyworp": "the large pulsating fleshy stomach of a glustyworp",
    "Mutageno della Strega dei Sepolcri": "a glowing organic mutagenic orb from a grave hag",
    "Mutageno della Viverna": "a glowing organic mutagenic orb from a wyvern",
    "Mutageno dell'Orso": "a glowing organic mutagenic orb from a bear",
    "Mutageno del Demonio": "a glowing organic mutagenic orb from a fiend",
    "Mutageno del Golem": "a glowing organic mutagenic orb from a golem"
};
...
<body>
    <h1>Prompts Batch ${BATCH_NUMBER} (Mutageni e Componenti DLC)</h1>
