...
lines.forEach(line => {
    ...
    if (match) {
        ...
        // Revised School Regex: Handle "Scuola dell'Orso" (no space after ')
...
// Move remaining (non-processed) to orphans
actualFiles.forEach(f => {
...
// 5. Final Report
fs.writeFileSync('e:/AntigravitiProgetti/CompendioTheWitcher/scratch/sanitization_report_v5.json', JSON.stringify(report, null, 2));

console.log(`\nSanitization V5 Complete:`);
