...
const weaponData = [
    ...
    { name: "Bastone con Cristallo", damage: "2d6+2", type: { bludgeoning: true }, accuracy: 0, reliability: 5, hands: "2", range: "Portata", effects: [{ name: "Focus (3)", percentage: 100 }, { name: "Focus Sup.", percentage: 100 }] },
    ...
    { name: "Bastone da Passeggio Elfico", damage: "3d6", type: { bludgeoning: true }, accuracy: 1, reliability: 10, hands: "2", range: "Portata", effects: [{ name: "Focus (3)", percentage: 100 }, { name: "Focus Sup.", percentage: 100 }] },
    ...
    { name: "Bacchetta della Succube", damage: "3d6+2", type: { bludgeoning: true }, accuracy: 0, reliability: 5, hands: "2", range: "Portata", effects: [{ name: "fuoco", percentage: 25 }, { name: "+2 Seduzione", percentage: 100 }, { name: "Focus Sup. (Fuoco)", percentage: 100 }, { name: "Focus (5)", percentage: 100 }] },
    { name: "Caroline", damage: "9d6", type: { piercing: true, slashing: true }, accuracy: 3, reliability: 15, hands: "2", effects: [{ name: "Focus Sup. (Acqua)", percentage: 100 }, { name: "+25 Punti Salute", percentage: 100 }, { name: "bilanciata", percentage: 100 }, { name: "sanguinamento", percentage: 75 }] },
    ...
    { name: "Destino", damage: "2d6+1", type: { piercing: true, slashing: true }, accuracy: 3, reliability: 10, hands: "2", silverTrait: true, silverDamage: "6d6+4", effects: [{ name: "Focus Sup. (Acqua/Fuoco)", percentage: 100 }, { name: "Vacillante", percentage: 75 }] },
    { name: "Devine", damage: "10d6", type: { piercing: true, slashing: true }, accuracy: 0, reliability: 20, hands: "2", isMeteorite: true, armorPiercing: true, stun: 2, effects: [{ name: "Focus Sup. (Aria)", percentage: 100 }] },
    ...
    { name: "Maugrim", damage: "2d6", type: { piercing: true, slashing: true }, accuracy: 0, reliability: 10, hands: "2", silverTrait: true, silverDamage: "6d6+4", effects: [{ name: "Focus Sup. (Terra/Acqua)", percentage: 100 }, { name: "bilanciata", percentage: 100 }, { name: "congelamento", percentage: 75 }] },
    ...
    { name: "Sentinella dell'Abisso", damage: "7d6+4", type: { piercing: true }, accuracy: 2, reliability: 10, hands: "2", range: "Portata", effects: [{ name: "congelamento", percentage: 75 }, { name: "Focus Sup. (Acqua)", percentage: 100 }] },
    { name: "Spada Lunare", damage: "3d6", type: { piercing: true, slashing: true }, accuracy: 1, reliability: 10, hands: "2", silverTrait: true, silverDamage: "7d6+4", effects: [{ name: "Focus Sup.", percentage: 100 }] },
