// Witcher Compendium Maintenance Tool: Sign Icon Updater
// VERSION: 1.0.0
// LAST_UPDATE: 2026-04-14
// DESCRIPTION: Maps Witcher Signs (Aard, Igni, etc.) to their specific icons and updates JSON metadata in src-packs.
...
const JSON_DIR = path.join(REPO_ROOT, '_tools', 'src-packs', 'MAGIA', 'base', 'witcher-signs');
...
function processSigns() {
    ...
    console.log(`✅ Updated ${updated} Witcher Signs.`);
}
