...
const priorityPacks = [
    'EQUIPAGGIAMENTO_E_TRASPORTI\\Armi_e_Armature\\witcher-weapons'
];
...
// Take Batch 28 (first 15)
const BATCH_SIZE = 15;
const batchItems = selectedItems.slice(0, BATCH_SIZE);

const translations = {
    "Arco da Viaggio Elfico": "an elegant elven travel bow",
    "Arco Lunare": "a beautiful elven moon bow with silver engravings",
    "Ascia Nanica": "a heavy double-edged dwarven axe",
    "Ascia Nera Gnomesca": "a sleek black gnomish axe with fine mechanical details",
    "Asta": "a simple wooden polearm shaft",
    "Bacchetta della Succube": "a decorative succubus wand with erotic and floral motifs",
    "Badile": "a sturdy metal shovel",
    "Balestra Pesante Nanica": "a powerful heavy dwarven crossbow with iron reinforcements",
    "Balestrino Gnomesco": "a small intricate gnomish hand-crossbow",
    "Bastone con Cristallo": "a wooden mage staff topped with a glowing crystal",
    "Bastone da Passeggio Elfico": "an elegant elven walking staff carved from light wood",
    "Bastone del Vincolo": "a magical binding staff with glowing runes",
    "Bastone di Ferro": "a solid iron staff",
    "Bastone Gnomesco": "a gnomish staff with mechanical brass parts",
    "Bastone Uncinato": "a wooden staff with a hooked iron tip"
};
...
batchItems.forEach(item => {
    ...
    const subject = translations[item.name] || ("a " + item.name);
...
<body>
    <h1>Prompts Batch ${BATCH_NUMBER} (Armi)</h1>
