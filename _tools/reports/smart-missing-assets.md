...
Data Scansione: 12/05/2026, 10:55:24
...
|---|---|---|
| Schema: Asce da Lancio (x3) | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_asce_da_lancio_x3_139cd011b5f432c7.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_asce_da_lancio_x3.webp` |
| Schema: Coltelli da Lancio (x3) | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_coltelli_da_lancio_x3_3ae97d399c900c27.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_coltelli_da_lancio_x3.webp` |
| Schema: Munizioni a Punta Larga (x10) | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_munizioni_a_punta_larga_x10_7b53ec7f7bf34eac.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_munizioni_a_punta_larga_x10.webp` |
| Schema: Munizioni Bodkin (x10) | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_munizioni_bodkin_x10_094dd115f8554ffe.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_munizioni_bodkin_x10.webp` |
| Schema: Orione (x3) | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_orione_x3_0c8eaef83981bedf.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_orione_x3.webp` |
| Schema: Rinforzo Elfico | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_rinforzo_elfico_2d0dfd770cbb7773.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_rinforzo_elfico.webp` |
| Schema: Rinforzo in Fibra | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_rinforzo_in_fibra_9917c793cba645a3.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_rinforzo_in_fibra.webp` |
| Schema: Rinforzo Nano | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_rinforzo_nano_5e082e424a3a4dab.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_rinforzo_nano.webp` |
| Schema: Schema Armi di Toussaint | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_armi_di_toussaint_24886ddd935af3d9.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_armi_di_toussaint.webp` |
| Schema: Schema Spada d'Acciaio del Manticora | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_acciaio_del_manticora_c96248758b2c1bce.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_acciaio_del_manticora.webp` |
| Schema: Schema Spada d'Acciaio del Orso | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_acciaio_del_orso_09658d766401261d.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_acciaio_del_orso.webp` |
| Schema: Schema Spada d'Acciaio del Vipera | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_acciaio_del_vipera_2b285bd6d0b28320.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_acciaio_del_vipera.webp` |
| Schema: Schema Spada d'Argento del Gatto | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_argento_del_gatto_1a300f6f3080d37e.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_argento_del_gatto.webp` |
| Schema: Schema Spada d'Argento del Grifone | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_argento_del_grifone_194ea9f9d9c7d479.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_argento_del_grifone.webp` |
| Schema: Schema Spada d'Argento del Lupo | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_argento_del_lupo_bb049103886bdafc.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_argento_del_lupo.webp` |
| Schema: Schema Spada d'Argento del Manticora | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_argento_del_manticora_f19cb95d6b19abfe.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_argento_del_manticora.webp` |
| Schema: Schema Spada d'Argento del Orso | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_argento_del_orso_1e19004d01539483.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_argento_del_orso.webp` |
| Schema: Schema Spada d'Argento del Vipera | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_spada_d_argento_del_vipera_6cc6acfeb594bd07.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_spada_d_argento_del_vipera.webp` |
| Schema: Schema Zanna del Vipera | _tools\src-packs\ALCHIMIA_E_ARTIGIANATO\witcher-schematics\schema_schema_zanna_del_vipera_d9748aefddd55105.json | `ALCHIMIA_E_ARTIGIANATO/witcher-schematics/schema_schema_zanna_del_vipera.webp` |
...
| Critici Mortali | _tools\src-packs\REGOLAMENTO_E_NARRATIVA\Tabelle_Operative\CriticieCombattimento\critici_mortali_79b6dc01eaf17a13.json | `REGOLAMENTO_E_NARRATIVA/Tabelle_Operative/CriticieCombattimento/critici_mortali.webp` |
| Critici Semplici | _tools\src-packs\REGOLAMENTO_E_NARRATIVA\Tabelle_Operative\CriticieCombattimento\critici_semplici_c643d9ff271bd482.json | `REGOLAMENTO_E_NARRATIVA/Tabelle_Operative/CriticieCombattimento/critici_semplici.webp` |
| Fumble - Disarmato | _tools\src-packs\REGOLAMENTO_E_NARRATIVA\Tabelle_Operative\CriticieCombattimento\fumble_disarmato_f75b23dcf048c0be.json | `REGOLAMENTO_E_NARRATIVA/Tabelle_Operative/CriticieCombattimento/fumble_disarmato.webp` |
| Fumble - Distanza | _tools\src-packs\REGOLAMENTO_E_NARRATIVA\Tabelle_Operative\CriticieCombattimento\fumble_distanza_ae00243fc142a619.json | `REGOLAMENTO_E_NARRATIVA/Tabelle_Operative/CriticieCombattimento/fumble_distanza.webp` |
